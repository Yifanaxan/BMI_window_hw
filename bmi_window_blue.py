...
#第一個pack
        ...
        ttk.Label(topFrame,text="快看自己的BMI是否在理想範圍吧!",foreground='#488AC7',style='gridLabel.TLabel').pack(pady=20,padx=20)
...
#Entry輸入身高
        ...
        self.height_entry=ttk.Entry(secFrame,width=10,style='gridEntry.TEntry')
...
#清除按鈕
        ...
        ttk.Label(secFrame,text="你的BMI為    ",style='gridLabel.TLabel').grid(column=1,row=2,padx=10,columnspan=2,sticky=tk.E)
